...
import { Card, CardContent, CardDescription, CardHeader, CardTitle, Badge, Button } from '@/components/ui/core-components';
import { 
  BookOpen, 
  Clock, 
  Trophy, 
...
function AdminDashboard({ user, greeting }) {
  const stats = [
...
function SuperAdminDashboard({ user, greeting }) {
  const systemStats = [
